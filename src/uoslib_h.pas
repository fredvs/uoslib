...
function uos_loadlibs(const uoslibfilename, portaudiofilename, sndfilefilename, mpg123filename,  Mp4ffFileName, FaadFileName, soundtouchfilename: pchar): boolean;
    ...
    begin
      try
       ...
       pointer(uos_beginproc) :=
        ...
        uos_loadlib(pchar(portaudiofilename), pchar(sndfilefilename), pchar(mpg123filename), nil, nil);
