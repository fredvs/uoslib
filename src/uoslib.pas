...
function uos_AddFromDevIn({$IF DEFINED(java)}PEnv: PJNIEnv; Obj: JObject; {$endif} PlayerIndex: cint32; Device: cint32; Latency: CDouble;
             ...
             SampleFormat: shortint; FramesCount : cint32; ChunkCount : cint32): cint32; cdecl;
...
procedure uos_InputSetLevelArrayEnable({$IF DEFINED(java)}PEnv: PJNIEnv; Obj: JObject; {$endif} PlayerIndex: cint32; InputIndex: cint32 ; levelcalc : cint32);
// set add level calculation in level-array (default is 0)
// 0 => no calcul
// 1 => calcul before all DSP procedures.
// 2 => calcul after all DSP procedures.
begin
uos_flat.uos_InputSetLevelArrayEnable(PlayerIndex, InputIndex, levelcalc);
end;
...
uos_getinfolibraries name 'Java_' + javappname  + 'uos_getinfolibraries',
...
uos_inputsetlevelarrayenable name 'Java_' + javappname  + 'uos_inputsetlevelarrayenable',
...
uos_getinfolibraries name 'uos_getinfolibraries',
...
uos_inputsetlevelarrayenable name 'uos_inputsetlevelarrayenable',
